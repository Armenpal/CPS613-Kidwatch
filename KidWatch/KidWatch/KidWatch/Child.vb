...
Public Class KidWatch
    ...
    Private Sub MusicButton_Click(sender As Object, e As EventArgs) Handles MusicButton.Click
        MainTabControl.SelectedTab = Wallet
    End Sub
    ...
    Private Sub Face1_Click(sender As Object, e As EventArgs)
        ...
        MainTabControl.SelectedTab = Clock
    End Sub
    Private Sub Face3_Click(sender As Object, e As EventArgs)
        ...
        MainTabControl.SelectedTab = Clock
    End Sub
    Private Sub Face2_Click(sender As Object, e As EventArgs)
        Clock.BackgroundImage = My.Resources.blue
        ...
        MainTabControl.SelectedTab = Clock
    End Sub
    Private Sub Face4_Click(sender As Object, e As EventArgs)
    ...
    Private Sub PlayMusic()
        ...
        My.Computer.Audio.Play(My.Resources.ResourceManager.GetObject(songs(songNumber)),
                               AudioPlayMode.Background)
        playing = True
        MusicTimer.Start()
    End Sub
    ' Toggle Repeat
    Private Sub RepeatButton_Click(sender As Object, e As EventArgs)
        If repeat Then
    ...
    End Sub
    Private Sub Playlist2_Click(sender As Object, e As EventArgs)
        MainTabControl.SelectedTab = Wallet
    End Sub
    ...
    Private Sub CallBtn_MouseClick(sender As Object, e As MouseEventArgs) Handles CallMomBtn.MouseClick, CallDadBtn.MouseClick, CallThomasBtn.MouseClick, CallJesBtn.MouseClick
        ...
        If calling Then
            ...
            If sender.Name = "CallMomBtn" Then
                ...
                ParentUI.ParentCallTitle.Text = "John"
    ...
    Private Sub SetContactPicture(name As String)
        If name = "CallMomBtn" Then
            CallerPicture.BackgroundImage = My.Resources.Ryan_Reynolds
        ElseIf name = "CallDadBtn" Then
            CallerPicture.BackgroundImage = My.Resources.gosling

        ElseIf name = "CallThomasBtn" Then
            CallerPicture.BackgroundImage = My.Resources.hems
        ElseIf name = "CallJesBtn" Then
            CallerPicture.BackgroundImage = My.Resources.lee
    ...
    Private Sub Message1_Click(sender As Object, e As EventArgs) Handles MsgSenderPicture1.Click, MsgPreviewPicture1.Click
        ...
        ViewingMessage(1)
    End Sub
    Private Sub Message2_Click(sender As Object, e As EventArgs) Handles MsgSenderPicture2.Click
    ...
    Private Sub NewMessage()
        ...
        MsgSenderPicture1.BackgroundImage = My.Resources.gosling
